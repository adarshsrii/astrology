...
const res=A.calculateBirthChart({date:'1992-10-05',time:'08:15',latitude:LAT,longitude:LON,timezone:TZ});
...
const d=A.calculateVimshottariDasha(new Date('1992-10-05T02:30:00Z'),m.nakshatra,(m.longitude%13.3333333),3);
