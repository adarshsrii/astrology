...
// Sumit Kumtha — 01 Mar 1979, 08:54 IST, Mumbai
const birth={date:'1979-03-01',time:'08:54',latitude:19.0760,longitude:72.8777,timezone:'Asia/Kolkata'};
...
// 08:54 IST = 03:24 UTC
const d=A.calculateVimshottariDasha(new Date('1979-03-01T03:24:00Z'),m.nakshatra,(m.longitude%13.3333333),2);
...
fs.writeFileSync('/tmp/_chart_s105.json',JSON.stringify({lagnaSign:res.lagna.signName,lagnaSignNum:sn(res.lagna.signName),nakshatra:res.lagna.nakshatra,houses,planets,dasha:{current:d.currentDasha,timeline}}));
console.log('WROTE /tmp/_chart_s105.json');
