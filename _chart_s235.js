...
const LAT=27.33,LON=86.48,TZ='Asia/Kathmandu';
const res=A.calculateBirthChart({date:'1996-08-14',time:'13:55',latitude:LAT,longitude:LON,timezone:TZ});
...
const d=A.calculateVimshottariDasha(new Date('1996-08-14T08:10:00Z'),m.nakshatra,(m.longitude%13.3333333),3);
