...
console.log('LAGNA',L.signName,L.degreeInSign.toFixed(2),'| MOON',m.signName,'(claims Leo)');
...
console.log('\nSWEEP:');[-15,-10,-5,0,5,10,15].forEach(o=>{const t=new Date(Date.UTC(2001,1,9,1,13)+o*60000);
...
console.log('\nTRANSITS:');['2026-08-16','2026-12-01','2027-04-01','2027-09-01','2028-04-01','2029-01-01','2030-01-01'].forEach(ds=>{
 const t=A.calculateBirthChart({date:ds,time:'12:00',latitude:28.21,longitude:83.99,timezone:'Asia/Kathmandu'});
