...
const LAT=27.86,LON=84.90,TZ='Asia/Kathmandu';
const res=A.calculateBirthChart({date:'1991-10-10',time:'12:05',latitude:LAT,longitude:LON,timezone:TZ});
...
const d=A.calculateVimshottariDasha(new Date('1991-10-10T06:20:00Z'),m.nakshatra,(m.longitude%13.3333333),3);
