...
const LAT=26.47,LON=74.64,TZ='Asia/Kolkata';
const res=A.calculateBirthChart({date:'1998-03-23',time:'19:32',latitude:LAT,longitude:LON,timezone:TZ});
...
const d=A.calculateVimshottariDasha(new Date('1998-03-23T14:02:00Z'),m.nakshatra,(m.longitude%13.3333333),3);
