...
const res=A.calculateBirthChart({date:'1981-03-01',time:'03:50',latitude:LAT,longitude:LON,timezone:TZ});
...
const d=A.calculateVimshottariDasha(new Date('1981-02-28T22:05:00Z'),m.nakshatra.replace('Mula','Moola'),(m.longitude%13.3333333),3);
