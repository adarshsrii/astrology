...
// s109 — 26 Nov 1983, 13:58 IST, Sonipat Haryana
const birth={date:'1983-11-26',time:'13:58',latitude:28.9931,longitude:77.0151,timezone:'Asia/Kolkata'};
...
// 13:58 IST = 08:28 UTC
const d=A.calculateVimshottariDasha(new Date('1983-11-26T08:28:00Z'),m.nakshatra,(m.longitude%13.3333333),2);
...
console.log('--- Dasha 2025-2029 ---');
const W=new Date('2025-01-01'),X=new Date('2029-12-31');
...
fs.writeFileSync('/tmp/_chart_s109.json',JSON.stringify({lagnaSign:res.lagna.signName,lagnaSignNum:sn(res.lagna.signName),nakshatra:res.lagna.nakshatra,houses,planets,dasha:{current:d.currentDasha,timeline}}));
console.log('WROTE /tmp/_chart_s109.json');
