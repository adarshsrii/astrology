...
exports.getNameSuggestions = exports.NAKSHATRA_SYLLABLES = void 0;
// ── Nakshatra Syllable Map (27 × 4 padas) ──────────────────────────────────────
exports.NAKSHATRA_SYLLABLES = {
 ...
 */
function getNameSuggestions(nakshatra, pada) {
    const syllables = exports.NAKSHATRA_SYLLABLES[nakshatra];
    if (!syllables) {
        return [];
    }
    if (pada < 1 || pada > 4) {
...
exports.getNameSuggestions = getNameSuggestions;
