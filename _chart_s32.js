...
// Kathmandu 27.7172N 85.324E; 4 Feb 1993 07:15 NPT => UTC 01:30
const birth={date:'1993-02-04',time:'07:15',latitude:27.7172,longitude:85.324,timezone:'Asia/Kathmandu'};
...
const d=A.calculateVimshottariDasha(new Date('1993-02-04T01:30:00Z'),m.nakshatra,(m.longitude%13.3333333),2);
console.log('CUR',JSON.stringify(d.currentDasha));
const W=new Date('2024-01-01'),X=new Date('2031-12-31');
