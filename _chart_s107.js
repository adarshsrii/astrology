...
// Suhani Kumari — 14 Jan 2005, 05:30 IST, Patna
const birth={date:'2005-01-14',time:'05:30',latitude:25.5941,longitude:85.1376,timezone:'Asia/Kolkata'};
...
// 05:30 IST = 00:00 UTC
const d=A.calculateVimshottariDasha(new Date('2005-01-14T00:00:00Z'),m.nakshatra,(m.longitude%13.3333333),2);
...
fs.writeFileSync('/tmp/_chart_s107.json',JSON.stringify({lagnaSign:res.lagna.signName,lagnaSignNum:sn(res.lagna.signName),nakshatra:res.lagna.nakshatra,houses,planets,dasha:{current:d.currentDasha,timeline}}));
console.log('WROTE /tmp/_chart_s107.json');
