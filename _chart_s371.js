...
const TZ='Asia/Kathmandu',DATE='1990-11-27',TIME='22:00';
[['Dogadakedar',29.35,80.55],['Baitadi HQ',29.55,80.55],['South',29.20,80.60]].forEach(([n,la,lo])=>{
 const r=A.calculateBirthChart({date:DATE,time:TIME,latitude:la,longitude:lo,timezone:TZ});
 console.log('LOC',n,'lagna',r.lagna.signName,r.lagna.degreeInSign.toFixed(2),r.lagna.nakshatra);});
const LAT=29.35,LON=80.55;
...
['2026-07-29','2026-11-15','2027-03-15','2027-07-15'].forEach(dt=>{
