...
console.log('\nSWEEP (time approx "11 baje tira"):');
[-60,-40,-20,0,20,40,60].forEach(o=>{const t=new Date(Date.UTC(2008,6,28,23,0)+o*60000);
 const rr=A.calculateBirthChart({...B,time:String(t.getUTCHours()).padStart(2,'0')+':'+String(t.getUTCMinutes()).padStart(2,'0')});
 console.log('  ',(o+'min').padStart(7),rr.lagna.signName,rr.lagna.degreeInSign.toFixed(2));});
console.log('\nTRANSITS:');
['2026-08-16','2027-01-01','2027-08-01','2028-06-01','2029-06-01','2030-06-01'].forEach(ds=>{
 const t=A.calculateBirthChart({date:ds,time:'12:00',latitude:26.62,longitude:88.05,timezone:'Asia/Kathmandu'});
