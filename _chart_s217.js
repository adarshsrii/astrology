...
const LAT=10.8791952,LON=76.3109986,TZ='Asia/Kolkata';
const res=A.calculateBirthChart({date:'1991-03-17',time:'00:12',latitude:LAT,longitude:LON,timezone:TZ});
...
const d=A.calculateVimshottariDasha(new Date('1991-03-16T18:42:00Z'),m.nakshatra,(m.longitude%13.3333333),3);
