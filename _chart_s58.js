...
const birth={date:'2000-08-13',time:'22:00',latitude:27.5833,longitude:85.3833,timezone:'Asia/Kathmandu'};
...
const d=A.calculateVimshottariDasha(new Date('2000-08-13T16:15:00Z'),m.nakshatra,(m.longitude%13.3333333),2);
...
fs.writeFileSync('/tmp/_chart_s58.json',JSON.stringify({lagnaSign:res.lagna.signName,lagnaSignNum:sn(res.lagna.signName),nakshatra:res.lagna.nakshatra,houses,planets,dasha:{current:d.currentDasha,timeline}}));
console.log('WROTE');
