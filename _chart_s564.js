...
[-10,0,10].forEach(off=>{let t=2*60+15+off;const tt=String(Math.floor(t/60)).padStart(2,'0')+':'+String(t%60).padStart(2,'0');
...
const d10=A.calculateDivisionalChart(10,pl,L);console.log('\nD10');d10.planets.forEach(p=>console.log('   ',p.planet.padEnd(8),p.vargaSignName));
...
console.log('\nTRANSITS monthly to end 2027');
for(let y=2026;y<=2027;y++)for(let mo=1;mo<=12;mo++){const ds=y+'-'+String(mo).padStart(2,'0')+'-01';
 ...
 console.log(' ',ds,'Ju',g('Jupiter'),'Sa',g('Saturn'),'Ra',g('Rahu'),'Ma',g('Mars'));}
