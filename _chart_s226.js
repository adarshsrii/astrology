...
const LAT=27.67,LON=85.32,TZ='Asia/Kathmandu';
const res=A.calculateBirthChart({date:'1998-03-12',time:'19:30',latitude:LAT,longitude:LON,timezone:TZ});
...
const d=A.calculateVimshottariDasha(new Date('1998-03-12T13:45:00Z'),m.nakshatra,(m.longitude%13.3333333),3);
