...
const LAT=28.70,LON=80.59,TZ='Asia/Kathmandu';
const res=A.calculateBirthChart({date:'1999-11-16',time:'02:30',latitude:LAT,longitude:LON,timezone:TZ});
...
const d=A.calculateVimshottariDasha(new Date('1999-11-15T20:45:00Z'),m.nakshatra,(m.longitude%13.3333333),3);
