...
const LAT=28.09,LON=83.87,TZ='Asia/Kathmandu';
const res=A.calculateBirthChart({date:'1995-09-10',time:'16:30',latitude:LAT,longitude:LON,timezone:TZ});
...
const d=A.calculateVimshottariDasha(new Date('1995-09-10T10:45:00Z'),m.nakshatra,(m.longitude%13.3333333),3);
