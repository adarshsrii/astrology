...
const LAT=23.0225,LON=72.5714,TZ='Asia/Kolkata';
const res=A.calculateBirthChart({date:'1992-08-22',time:'05:45',latitude:LAT,longitude:LON,timezone:TZ});
...
const d=A.calculateVimshottariDasha(new Date('1992-08-22T00:15:00Z'),m.nakshatra,(m.longitude%13.3333333),3);
