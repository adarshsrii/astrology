...
const birth={date:'2006-02-12',time:'14:30',latitude:26.9,longitude:78.4,timezone:'Asia/Kolkata'};
...
const d=A.calculateVimshottariDasha(new Date('2006-02-12T09:00:00Z'),m.nakshatra,(m.longitude%13.3333333),2);
