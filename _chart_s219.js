...
const LAT=28.10,LON=82.87,TZ='Asia/Kathmandu';
const res=A.calculateBirthChart({date:'1998-01-19',time:'14:00',latitude:LAT,longitude:LON,timezone:TZ});
...
const d=A.calculateVimshottariDasha(new Date('1998-01-19T08:15:00Z'),m.nakshatra,(m.longitude%13.3333333),3);
