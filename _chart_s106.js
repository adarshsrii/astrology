...
// Rajesh Babu — 06 Apr 1981, 04:30 IST, Vijayawada AP
const birth={date:'1981-04-06',time:'04:30',latitude:16.5062,longitude:80.6480,timezone:'Asia/Kolkata'};
...
// 04:30 IST = prev day 23:00 UTC
const d=A.calculateVimshottariDasha(new Date('1981-04-05T23:00:00Z'),m.nakshatra,(m.longitude%13.3333333),2);
...
console.log('--- Dasha 2022-2029 ---');
const W=new Date('2022-01-01'),X=new Date('2029-12-31');
...
fs.writeFileSync('/tmp/_chart_s106.json',JSON.stringify({lagnaSign:res.lagna.signName,lagnaSignNum:sn(res.lagna.signName),nakshatra:res.lagna.nakshatra,houses,planets,dasha:{current:d.currentDasha,timeline}}));
console.log('WROTE /tmp/_chart_s106.json');
